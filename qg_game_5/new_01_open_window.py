...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.player_sprite = arcade.Sprite('images/player_1/charizard.png', CHARACTER_SCALING)
        ...
        texture = arcade.load_texture("images/player_1/clean_charizard.png", mirrored=True, scale=CHARACTER_SCALING)
        self.player_sprite.textures.append(texture)
        texture = arcade.load_texture("images/player_1/clean_charizard.png", scale=CHARACTER_SCALING)
        self.player_sprite.textures.append(texture)
        texture = arcade.load_texture("images/player_1/clean_charizard_purple.png", scale=CHARACTER_SCALING)
        self.player_sprite.textures.append(texture)
